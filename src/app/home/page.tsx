...
const [isBlurred, setIsBlurred] = useState(false);
  ...
  const handleScroll = () => {
	console.log('Position du défilement:', window.scrollY);
  ...
  useEffect(() => {
	console.log("Ajout de l'écouteur d'événement resize");
		window.addEventListener('scroll', handleScroll);
    return () => {
	console.log("Suppression de l'écouteur d'événement resize");
    ...
    return (
        <div className='min-h-screen overflow-hidden bg-stone-100'>
			...
			<div className="bg-[url('/photo1.webp')] relative bg-cover bg-center bg-fixed h-screen w-full flex flex-col mb-5">
				...
				<div className='flex flex-col items-center justify-center p-3 m-5 border shadow-xl border-slate-200 '>
					...
					<p className="m-5 font-serif text-2xl font-thin tracking-wide text-center text-gray-800">Travel Buddy est une application innovante conçue pour rendre chaque séjour plus agréable et plus simple,
				...
				<div className= "flex flex-col w-full mb-5 mr-5 border shadow-lg bg-amber-500 min-h-96 border-slate-200 md:flex-row md:mr-20">
					...
					<div className="flex flex-col w-full mb-5 mr-5 border shadow-lg bg-amber-500 min-h-96 border-slate-200 md:flex-row md:mr-20">
						...
						<div className="flex flex-col items-center justify-center w-full p-5 m-5 text-balance md:w-1/2">
							...
							<p className="text-2xl font-thin tracking-wide text-center text-gray-800">
							Un système de chat intégré permet une communication fluide et instantanée entre vous et vos hotes.							</p>
						</div>
					</div>
					...
					<div className="flex flex-col w-full mb-5 ml-5 bg-white border shadow-lg min-h-96 border-slate-200 md:flex-row-reverse md:ml-20">
						...
						<div className="flex flex-col items-center justify-center w-full p-5 m-5 md:w-1/2">
							...
							<p className="text-2xl font-thin tracking-wide text-center text-gray-800">
							Offrez à vos invités des recommandations personnalisées pour découvrir les meilleurs sites touristiques, restaurants, magasins et activités de votre région.			</p>
						</div>
					</div>
					<div>
						<PrincingCard />
					</div>
					<div className='flex flex-col items-center justify-center w-full bg-amber-500'>
