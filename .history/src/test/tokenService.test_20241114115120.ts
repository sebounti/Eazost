import db from '@/db/db';  // Importation correcte du module db
import { generateAccessToken, saveTokenToDatabase, verifyAccountToken, verifyToken, refreshToken, setAuthCookies } from '@/app/api/services/tokenService';
import jwt from 'jsonwebtoken';  // Ajouter cette ligne en haut de votre fichier
import { verifySessionToken } from '@/app/api/services/tokenService';  // Assurez-vous de l'importer correctement
