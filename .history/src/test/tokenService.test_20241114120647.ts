...
// Solution 1 : Définir le type explicitement
// const mockSelectBuilder = {
//   where: jest.fn().mockReturnThis()
// } as unknown as MySqlSelectBuilder<SelectedFields, MySql2PreparedQueryHKT, "db">;

// Solution 2 : Créer une interface partielle
interface PartialSelectBuilder {
  where: jest.Mock;
}

// const mockSelectBuilder = {
//   where: jest.fn().mockReturnThis()
// } as PartialSelectBuilder;
