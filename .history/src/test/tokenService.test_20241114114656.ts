...
import { generateAccessToken, saveTokenToDatabase, verifyAccountToken, verifyToken, verifySessionToken, refreshToken } from '@/app/api/services/tokenService';
...
function setAuthCookies(response: { headers: { append: jest.Mock<(header: string, value: string) => void>; }; }, accessToken: string, refreshToken: string) {
