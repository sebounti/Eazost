    ...
    try {
      ...
      const user = {
        ...
        isAuthenticated: true,
			...
			console.log("Données utilisateur avant stockage dans localStorage:", user);
			localStorage.setItem('currentUser', JSON.stringify(user)); // Stocke d'abord dans localStorage
			const storedUser = localStorage.getItem('currentUser'); // Vérifie immédiatement après
			console.log("Vérification après stockage dans localStorage:", storedUser);
