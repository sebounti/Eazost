...
export default function RegisterPage() {
  ...
  const [error, setError] = useState<string | null>(null); // Utiliser 'error' en minuscules pour éviter toute confusion
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const redirectUrl = data.account_type === "owner" ? "/dashboard" : "/dashboard";
        setTimeout(() => {
		...
		console.log("Type de err :", typeof err);
		console.log("Constructeur de err :", err instanceof Error ? "Error" : err.constructor.name);
		console.log("Contenu de err :", err);
	  }
  };
