...
export default function RegisterPage() {
	...
	const { setCurrentUser } = useUser() as UserContextType;
	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			if (response.ok) {
			  ...
			  // Met à jour `currentUser` avec les données utilisateur
			...
			try {
			  ...
			  setError(err instanceof globalThis.Error ? err.message : "Une erreur inconnue s'est produite.");
