...
export default function LogementsPage() {
  ...
  return (
    <div className="container p-4 mx-auto">
      <h1 className="text-5xl font-extrabold tracking-tight">Gestion des Logements</h1>
      <p className="mb-8 text-muted-foreground">Gérez vos propriétés, codes d&apos;accès, Carte info logement  et commandes en un seul endroit</p>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {logements.map((logement) => (
          <LogementCard
            ...
            onAddOrder={(logementId, formData) => { /* Ajouter une commande */ }}
            onEditOrder={(logementId, orderId, formData) => {
