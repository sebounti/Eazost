    ...
    <div className="container p-4 mx-auto">
      ...
      {isDialogOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-4 border-gray-200  border-2 rounded-xl shadow-lg max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <button onClick={() => setIsDialogOpen(false)} className="text-red-500 mb-2 flex justify-end">Fermer</button>
