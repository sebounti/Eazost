...
import LogementForm from "@/components/forms/LogementForm"; // Importez votre composant LogementForm
  ...
  return (
    <div className="container p-4 mx-auto">
      ...
      <form onSubmit={(e) => {
        ...
        <button type="submit" className="bg-amber-400 rounded-xl shadow-lg p-2 text-ellipsis">Ajouter Logement</button>
      </form>
