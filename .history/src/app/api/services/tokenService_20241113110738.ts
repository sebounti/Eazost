...
// Fonction pour générer un token JWT avec userId en tant qu'entier
export function generateToken(userId: number, account_type: string) {
    ...
    return jwt.sign({ userId, role: account_type }, secretKey, { expiresIn: '5h' }); // Expiration après 5 heures
}
...
// Fonction pour vérifier et valider le token inscription 
