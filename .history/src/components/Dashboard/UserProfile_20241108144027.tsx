    ...
    <div className="w-full max-h-screen">
          <div className="relative flex justify-center">
			...
			<Avatar className="rounded-full h-55 w-55">
                <AvatarImage src={profileImage || "@/assets/public/icons-profil.png"} alt="Profil image" className="object-cover w-40 h-40 rounded-full  border-gray-200 border-2" />
				<AvatarFallback className="rounded-full ">
				<FaUser className="text-gray-400 w-84 h-84" />
				</AvatarFallback>
              </Avatar>
            </div>
            <Button
