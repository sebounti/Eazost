    ...
    <div className="w-full max-h-screen">
          <div className="relative flex justify-center">
			...
			<Avatar className="rounded-full h-55 w-55">
                <AvatarImage src={profileImage || "/utilisateur.png"} alt="Profil image" className="object-cover w-40 h-40 rounded-full  border-gray-200 border-2" />
      ...
      <div className="max-w-4xl px-4 py-6 mx-auto">
        ...
        <p className="mb-2 text-lg text-center text-black ">Propriétaire</p>
		</div>
    </div>
  )
}
