...
export default function UserProfile() {
  const [profileImage, setProfileImage] = useState("/icons-profil.png")
          ...
          <div className="relative flex justify-center">
            <div className="inline-block p-1 bg-white rounded-full">
              <Avatar className="rounded-full h-55 w-55">
                <AvatarImage src={profileImage || "@/assets/"} alt="Profil image" className="object-cover w-40 h-40 rounded-full  border-gray-200 border-2" />
