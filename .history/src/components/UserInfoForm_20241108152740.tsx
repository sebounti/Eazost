        ...
        <Card>
          ...
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input id="email" name="email" type="email" placeholder="votre@email.com" readOnly value={authData.email} className="text-lg shadow-md rounded-xl w-1/2" />
              {errors.email && <p className="text-red-500">{errors.email}</p>}
            </div>
            <div className="grid gap-2">
              <Label htmlFor="password" className="text-lg">Mot de passe</Label>
              <Input id="password" name="password" type="password" value='***********' readOnly className="shadow-md rounded-xl w-1/2" onChange={handleChange} />
