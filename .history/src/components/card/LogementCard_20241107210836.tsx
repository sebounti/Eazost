...
const LogementCard = ({
  ...
  <div className="overflow-hidden border rounded-lg shadow">
    ...
    <div className="p-4">
      <h2 className="mb-2 text-xl font-semibold">{Accommodation.nom}</h2>
      <p className="mb-2 text-sm text-gray-500">{Accommodation.infoCards.length} carte(s) d&apos;information</p>
      <p className="mb-2 text-sm text-gray-500">{Accommodation.products.length} produit(s) dans le shop</p>
      <p className="mb-4 text-sm text-gray-500">{Accommodation.orders.length} commande(s)</p>
