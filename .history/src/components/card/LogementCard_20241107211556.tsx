...
import { Accommodation, stayInfo, Product, Orders, AccessCode, Order } from "@/types";
...
const LogementCard = ({
  ...
  <div className="overflow-hidden border rounded-lg shadow">
    <Image src={logement.photo_url || "/default-image.jpg"} alt={logement.name} className="object-cover w-full h-48" />
    <div className="p-4">
      <h2 className="mb-2 text-xl font-semibold">{logement.name}</h2>
      <p className="mb-2 text-sm text-gray-500">{logement.stayInfo.length} carte(s) d&apos;information</p>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <InfoCardDialog
            ...
            onSubmit={(formData) => onAddInfoCard(logement.accommodation_id, formData)}
          />
        ...
        <AccessCodeDialog
          logementNom={logement.name}
          accessCodes={logement.AccessCode}
