...
const LogementForm = ({ logement, onSubmit }: LogementFormProps) => (
  <form onSubmit={(e) => { e.preventDefault(); onSubmit(new FormData(e.currentTarget)); }} className="space-y-4">
    ...
    <div className="space-y-2">
      ...
      <Input id="adresse1" name="adresse1" defaultValue={logement?.adress1} required />
    </div>
    <div className="space-y-2">
    ...
    <div className="space-y-2">
      ...
      <Input id="codePostal" name="codePostal" defaultValue={logement?.zipcoode} required />
    </div>
    <div className="space-y-2">
    ...
    <div className="space-y-2">
      ...
      <Input id="photo" name="photo" type="url" defaultValue={logement?.photo_} required />
    </div>
