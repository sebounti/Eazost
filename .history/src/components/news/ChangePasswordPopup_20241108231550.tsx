  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="w-auto rounded-xl bg-amber-400 text-md">Changer le mot de passe</Button>
      </DialogTrigger>
          ...
          <div className="grid gap-4 py-4 bg-white">
            {requireOldPassword && (
              <div className="grid grid-cols-4 items-center gap-4 relative">
                ...
                <Input
                  ...
                  className="col-span-3 bg-gray-200 rounded-xl"
                  value={oldPassword}
            ...
            <div className="grid grid-cols-4 items-center gap-4 relative">
              ...
              <Input
                ...
                className="col-span-3 bg-gray-200 rounded-xl text-lg"
