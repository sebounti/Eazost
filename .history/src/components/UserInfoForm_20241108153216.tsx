          ...
          <CardContent className="grid gap-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="grid gap-2">
                ...
                <Input id="first_name" name="first_name" className="shadow-md rounded-xl w-2/3" value={formData.first_name} onChange={handleChange} />
                {errors.first_name && <p className="text-red-500">{errors.first_name}</p>}
              </div>
              <div className="grid gap-2">
                <Label htmlFor="last_name" className="text-lg">Nom</Label>
                <Input id="last_name" name="last_name" className="shadow-md rounded-xl w-2/3" value={formData.last_name} onChange={handleChange} />
            ...
            <div className="grid gap-2">
              ...
              <Input id="address_line1" name="address_line1" className="shadow-md rounded-xl w-3/4 text-lg" value={formData.address_line1} onChange={handleChange} />
            ...
            <div className="grid gap-2">
              ...
              <Input id="address_line2" name="address_line2" className="shadow-md rounded-xl w-3/4 text-lg" value={formData.address_line2} onChange={handleChange} />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Input id="city" name="city" className="shadow-md rounded-xl w-2/3" value={formData.city} onChange={handleChange} />
