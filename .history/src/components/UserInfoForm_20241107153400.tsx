...
export default function UserInfoForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
		...
		const dataToSend = {
		  ...formData,
		  date_of_birth: new Date(formData.date_of_birth), // Conversion en objet Date
		};
        ...
        <Card>
          ...
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input id="email" name="email" type="email" placeholder="votre@email.com" readOnly value={authData.email} className="text-lg shadow-md rounded-xl" />
              {errors.email && <p className="text-red-500">{errors.email}</p>}
            </div>
            <div className="grid gap-2">
              <Label htmlFor="password" className="text-lg">Mot de passe</Label>
              <Input id="password" name="password" type="password" value='***********' readOnly className="shadow-md rounded-xl" onChange={handleChange} />
          ...
          <CardContent className="grid gap-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="grid gap-2">
                ...
                <Input id="first_name" name="first_name" className="shadow-md rounded-xl" value={formData.first_name} onChange={handleChange} />
                {errors.first_name && <p className="text-red-500">{errors.first_name}</p>}
              </div>
              <div className="grid gap-2">
                <Label htmlFor="last_name" className="text-lg">Nom</Label>
                <Input id="last_name" name="last_name" className="shadow-md rounded-xl" value={formData.last_name} onChange={handleChange} />
            ...
            <div className="grid gap-2">
              ...
              <Input id="date_of_birth" name="date_of_birth" type="date" className="shadow-md rounded-xl" value={formData.date_of_birth} onChange={handleChange} />
            ...
            <div className="grid gap-2">
              ...
              <Input id="phone_number" name="phone_number" type="tel" className="shadow-md rounded-xl" value={formData.phone_number} onChange={handleChange} />
            ...
            <div className="grid gap-2">
              ...
              <Input id="address_line1" name="address_line1" className="shadow-md rounded-xl" value={formData.address_line1} onChange={handleChange} />
            ...
            <div className="grid gap-2">
              ...
              <Input id="address_line2" name="address_line2" className="shadow-md rounded-xl" value={formData.address_line2} onChange={handleChange} />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Input id="city" name="city" className="shadow-md rounded-xl" value={formData.city} onChange={handleChange} />
                {errors.city && <p className="text-red-500">{errors.city}</p>}
              </div>
              <div className="grid gap-2">
                <Label htmlFor="zipcode" className="text-lg">Code postal</Label>
                <Input id="zipcode" name="zipcode" className="shadow-md rounded-xl" value={formData.zipcode} onChange={handleChange} />
            ...
            <div className="grid gap-2">
              ...
              >
                <SelectTrigger id="country" name="country" className="text-lg bg-white shadow-md rounded-xl">
            ...
            <div className="flex justify-start mt-4">
              <Button type="submit" className="w-auto rounded-xl bg-amber-400 text-md" disabled={isLoading}>
                {isSubmitted ? 'Modifier' : 'Soumettre'} {/* Affichage dynamique du texte sur le bouton */}
              </Button>
            </div>
          </CardContent>
        </Card>
